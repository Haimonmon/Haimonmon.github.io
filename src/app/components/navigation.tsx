    ...
    return (
        <>
            <div className="w-full h-16.5 fixed top-0
                ...
                <div className={`large-pablet:p-0 text-[2.5rem] font-[Fira_Code] text-right pr-7 pl=2 flex flex-col h-full w-full bg-dark-coded z-1 fixed top-16.5 
                    ${isMenuClosed 
                    ? '[clip-path:inset(0_0_100%_0)]' 
                    : '[clip-path:inset(0_0_0_0)]'} 
                    motion-safe:transition-[clip-path] duration-800 ease-in-out 
                    tablet:motion-safe:transition-none tablet:[clip-path:inset(0_0_0_0)] tablet:gap-12.5 tablet:justify-end tablet:p-0 tablet:static tablet:z-2 tablet:top-0 tablet:flex-row tablet:h-16.5`}>
